        ...
        return (
            <>
                ...
                <h1>User</h1>
                    ...
                    <input type="text" name='product_available' placeholder='Availability' ref={product_available} /><br/><br/>
                    <button type='button' class="btn btn-primary" onClick={submit_handle}>Submit</button>
                </div>
                {
                    data?.map((val, ind) => {
                        return (
                            ...
                            <div class = 'App'>
                                ...
                                <button class= "btn btn-danger" onClick={() => delete_handler(ind)}>Delete</button>
                                <button class="btn btn-success" type="button" data-toggle="modal" data-target="#exampleModalCenter" onClick={() => view_handler(ind)}>View</button>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Product Name : <input type="text" name='product_name' placeholder='Product name' value={view.product_name} onChange={update_input_handler} /><br/>
                                                Product Price : <input type="number" name='product_price' placeholder='Product price' value={view.product_price} onChange={update_input_handler} /><br/>
                                                Availability : <input type="text" name='product_available' placeholder='Availability' value={view.product_available} onChange={update_input_handler} />
                                            </div>
